...
+ *Analytical Methods*: Hierarchical agglomerative clustering (Ward's linkage, Euclidean distance), principal component analysis (PCA), Random Forest classification, and Phi coefficient co-resistance analysis.
...
+ *Regional Representation*: The three study regions may not be representative of all Philippine provinces, limiting generalizability to unstudied areas.

+ *Missing Data*: Some isolates lacked complete antibiotic panel coverage, potentially affecting cluster assignments for partially tested specimens.
